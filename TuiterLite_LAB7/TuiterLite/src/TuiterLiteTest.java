...
public class TuiterLiteTest {
    ...
    @Test
    public void testeAutorDoTuite() throws TuiteExcedenteException, UsuarioDesconhecidoException {
    ...
    @Test
    public void testeTuiteDeUsuarioDesconhecido() throws TuiteExcedenteException, UsuarioDesconhecidoException {
        try{
            tuiterLite.tuitarAlgo(
                    new Usuario("Usuário Desconhedido", "unknown@void.com"),
                    "Testando");
            fail();
        } catch (TuiteExcedenteException e) {
            fail();
    ...
    @Test
    public void testeTamanhoTuite() throws TuiteExcedenteException, UsuarioDesconhecidoException {
    ...
    public void testeAnexo() throws TuiteExcedenteException, UsuarioDesconhecidoException {
    ...
    @Test
    public void testeApenasUmTipoPermitidoComoAnexo() throws TuiteExcedenteException, UsuarioDesconhecidoException {
...
//        tuite.anexarAlgo(new Object());  // essa linha, se fosse descomentada, daria erro de compilação
    ...
    @Test
    public void testeHashtags() throws TuiteExcedenteException, UsuarioDesconhecidoException {
    ...
    @Test
    public void testeTipoUsuario() throws TuiteExcedenteException, UsuarioDesconhecidoException {
        // sanity check
    ...
    @Test
    public void testeTuiteExcedenteExeception () {
        try {
            tuiterLite.tuitarAlgo(usuario,"12345678901234567890123456789012345678901234567890123456789012345678901234566789012345678901234567890123456789012345678901234567890");
            fail();
        } catch (UsuarioDesconhecidoException e) {
            fail();
        } catch (TuiteExcedenteException e) {
            System.out.println("Tuite grande demais");
        }
    ...
    @Test
    public void testeUsuarioDesconhecidoException(){
        Usuario u = new Usuario("felipe", "desconhecido@dcc.com");
        try{
            tuiterLite.tuitarAlgo(u,"teste");
            fail();
        } catch (UsuarioDesconhecidoException e) {
            System.out.println("Usuario não conhecido");
        } catch (TuiteExcedenteException e) {
            fail();
        }
    }
    ...
    @Test
    public void testePerformanceContabilizacaoDasHashtags() throws TuiteExcedenteException, UsuarioDesconhecidoException {
    ...
    /////
    @Test
    public void testePerformanceTuites() throws TuiteExcedenteException, UsuarioDesconhecidoException {
        int tamanho = 32000;
